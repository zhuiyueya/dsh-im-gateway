 ...
 */
function zonedEpoch(y, mo, d, h, mi, tz, s = 0) {
 ...
 * 非法输入返回 undefined。
 */
export function parseAbsoluteAt(at, tz) {
    const trimmed = at.trim();
    const withOffset = Date.parse(trimmed);
    if (Number.isFinite(withOffset) && /Z|[+-]\d{2}:\d{2}$/.test(trimmed))
        return withOffset;
 ...
 */
export function nextOccurrence(schedule, fromEpochMs) {
...
//# sourceMappingURL=cron-time.js.map